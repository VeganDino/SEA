...
import com.sea.common.auth.CustomAccessDeniedHandler;
import com.sea.common.auth.CustomAuthenticationEntryPoint;
import com.sea.common.auth.JwtAuthenticationFilter;
import com.sea.common.auth.UserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable() // csrf 미적용
				...
				.antMatchers("/api/vi/animal/my-list", "/api/v1/user/test-result", "/api/vi/donation").hasAnyRole("USER", "ADMIN") // 로그인한 유저만 접근 가능 경로
